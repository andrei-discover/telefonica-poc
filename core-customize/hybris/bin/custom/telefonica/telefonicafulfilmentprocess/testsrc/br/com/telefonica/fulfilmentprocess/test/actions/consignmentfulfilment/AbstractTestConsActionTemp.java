 ...
 */
package br.com.telefonica.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, TelefonicaFulfilmentProcessConstants.PARENT_PROCESS);
