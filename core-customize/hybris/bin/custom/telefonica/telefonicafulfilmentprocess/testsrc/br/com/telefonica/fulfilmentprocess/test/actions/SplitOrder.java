 ...
 */
package br.com.telefonica.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TelefonicaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TelefonicaFulfilmentProcessConstants.PARENT_PROCESS);
