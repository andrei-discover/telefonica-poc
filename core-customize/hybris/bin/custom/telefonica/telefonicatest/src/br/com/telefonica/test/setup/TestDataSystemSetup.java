 ...
 */
package br.com.telefonica.test.setup;
...
import br.com.telefonica.test.constants.TelefonicaTestConstants;
import br.com.telefonica.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TelefonicaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/telefonicatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/telefonicatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/telefonicatest/import/cstickets.impex");
			...
			importImpexFile(context, "/telefonicatest/import/csquotes.impex");
		}
	}
}
