 ...
 */
package br.com.telefonica.core.constants;

/**
 * Global class for all TelefonicaCore constants. You can add global constants for your extension into this class.
 */
public final class TelefonicaCoreConstants extends GeneratedTelefonicaCoreConstants
{
	public static final String EXTENSIONNAME = "telefonicacore";


	private TelefonicaCoreConstants()
	{
		//empty
	}
