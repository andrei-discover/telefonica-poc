 ...
 */
package br.com.telefonica.core.suggestion;
...
import br.com.telefonica.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/telefonicacore/test/testSimpleSuggestionService.csv", "utf-8");
	}
